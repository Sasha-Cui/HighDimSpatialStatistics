...
# marginal and cross optimisation codes that adaptively halve the stepsizes.

# Marginal Parameters Optimization
...
# 12 Oct 2024 includes the saving and loading of parameters over different times. 
