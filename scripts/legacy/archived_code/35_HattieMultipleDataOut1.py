# Generated from /Users/cui/Documents/GitHub/HighDimSpatialStatistics/notebooks/legacy/archived_code/35_HattieMultipleDataOut1.ipynb on 2026-02-03 10:31:16
...
heads = [4000, 6000, 8000, 10000, 12000]
...
# %%
main(10, memory_usages)

# %%
main(20, memory_usages)

# %%
main(30, memory_usages)

# %%
main(40, memory_usages)

# %%
main(50, memory_usages)

# %%
main(60, memory_usages)

# %%
main(70, memory_usages)

# %%
main(80, memory_usages)

# %%
main(90, memory_usages)

# %%
main(100, memory_usages)

# %%
memory_usages = []
memory_usages = main(4000, memory_usages)

# %%
# <span id="papermill-error-cell" style="color:red; font-family:Helvetica Neue, Helvetica, Arial, sans-serif; font-size:2em;">Execution using papermill encountered an exception here and stopped:</span>

# %%
memory_usages = main(6000, memory_usages)

# %%
memory_usages = main(8000, memory_usages)

# %%
memory_usages = main(10000, memory_usages)

# %%
memory_usages = main(12000, memory_usages)
