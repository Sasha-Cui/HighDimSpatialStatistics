# Generated from /Users/cui/Documents/GitHub/HighDimSpatialStatistics/notebooks/legacy/archived_code/36_SubsamplingwReplacementDayOut.ipynb on 2026-02-03 10:31:16
...
# %%
head = 50 # how many locations to consider in the real data set.
estimated_params_df = pd.DataFrame()
for _ in range(25): # sub sampling with replacement the top head rows
    try:
