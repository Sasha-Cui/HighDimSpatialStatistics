...
- [VENUE_ROADMAP.md](VENUE_ROADMAP.md): realistic venue standards and verified
  dates known on the audit date.
- [REPOSITORY_PLAN.md](REPOSITORY_PLAN.md): cleanup, data provenance, testing,
...
likelihood, and smoothing-covariance defects documented here were found.
